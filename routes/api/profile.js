...
router.get('/user/:user_id', async (req, res) => {
    try {
        ...
        console.error(err.message);
        // If the user id is not a valid object id, return the same error message as if the profile was not found
...
router.delete('/experience/:exp_id', auth, async (req, res) => {
    try {
        ...
        // Remove the experience using .splice() which takes in the index of the item to remove
